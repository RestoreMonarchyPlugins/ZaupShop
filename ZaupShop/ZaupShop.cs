...
namespace ZaupShop
{
    public class ZaupShop : RocketPlugin<ZaupShopConfiguration>
    {
        ...
        public override TranslationList DefaultTranslations => new TranslationList
        {
            ...
            { "invalid_cost", "You have entered in an invalid cost value." },
            { "invalid_buyback", "You have entered in an invalid buyback value." },
            ...
            { "no_permission_shop_chng", "You don't have permission to use the shop change command." },
            { "no_permission_shop_add", "You don't have permission to use the shop add command." },
            { "no_permission_shop_rem", "You don't have permission to use the shop remove command." },
            { "no_permission_shop_buy", "You don't have permission to use the shop buy command." },
            { "changed", "changed" },
            { "added", "added" },
